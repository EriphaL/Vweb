...
const models = nestjs_typegoose_1.TypegooseModule.forFeature([
    user_model_1.User, course_model_1.Course, episode_model_1.Episode
]);
...
DbModule = __decorate([
    ...
    common_1.Module({
        imports: [
            nestjs_typegoose_1.TypegooseModule.forRoot('mongodb://localhost/v-web', {
...
__decorate([
    swagger_1.ApiModelProperty({ description: '密码', example: 'pass1' }),
    typegoose_1.prop(),
    __metadata("design:type", String)
...
__decorate([
    swagger_1.ApiModelProperty({ description: '封面' }),
    typegoose_1.prop(),
    __metadata("design:type", String)
...
__decorate([
    swagger_1.ApiModelProperty({ description: '课时' }),
    typegoose_1.prop(),
    __metadata("design:type", String)
], Episode.prototype, "name", void 0);
__decorate([
    swagger_1.ApiModelProperty({ description: '文件' }),
    typegoose_1.prop(),
    __metadata("design:type", String)
